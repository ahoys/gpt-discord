...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                ...
                .addChoices(
                    { name: 'Take part to all discussion', value: '3' },
                    { name: 'React to bad arguments', value: '2' },
                    { name: 'Warn about misbehavior', value: '1' },
    ...
    execute: async ({ db, interaction }: ICmdProps) => {
        ...
        const setting =
            interaction.options.getString('setting') || config.moderation.defaultModeration;
        if (
            typeof guild === 'string' &&
